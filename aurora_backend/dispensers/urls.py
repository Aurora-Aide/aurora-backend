...
from .views import (
    ...
    ContainerDispenseNowView,
    RegisterMobilePushTokenView,
    DeactivateMobilePushTokenView,
...
urlpatterns = [
    ...
    path('containers/<int:container_id>/dispense-now/', ContainerDispenseNowView.as_view(), name='container-dispense-now'),
    path('notifications/push-token/register/', RegisterMobilePushTokenView.as_view(), name='register-mobile-push-token'),
    path('notifications/push-token/deactivate/', DeactivateMobilePushTokenView.as_view(), name='deactivate-mobile-push-token'),
